                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="?page=admin&aksi=barang">Skincare</a>
                            </li>
                            <li>
                                <a href="?page=admin&aksi=makanan">Kosmetik</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="?page=admin&aksi=tampil_barang">Skincare</a>
                            </li>
                            <li>
                                <a href="?page=admin&aksi=lihat_makanan">Kosmetik</a>
                            </li>
                        </ul>
                    </li>
                    <li>
