		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-12">
					...
					include "koneksi.php";
					$kdbrg = @$_GET['kdbrg'];
					$sql = mysqli_query($koneksi, "select * from barang where br_id = '$kdbrg'");
					...
					?>
						...
						<?php
							...
							mysqli_query($koneksi, "UPDATE barang SET br_nm = '$br_nm',br_hrg = '$br_hrg',br_stok = '$br_stok',br_satuan ='$br_satuan',ket = '$ket',br_sts = '$br_sts' WHERE br_id = $kdbrg;");
						?>
