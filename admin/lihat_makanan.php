                ...
                <tbody>
                    ...
                    ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <center><a href="?page=admin&aksi=edit_makanan&kdbrg=<?php echo $data['br_id']; ?>"> <button class="btn btn-info"> Edit</button> </a>
                                    <a onclick="return confirm('Yakin ingin hapus data ini ??')" href="?page=admin&aksi=hapus_makanan&kdbrg=<?php echo $data['br_id']; ?>"> <button class="btn btn-danger"> Hapus</button> </a>
                                </center>
                            </td>
                        </tr>
                    <?php
