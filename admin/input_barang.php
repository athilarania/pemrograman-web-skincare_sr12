				...
				<div class="col-md-12">
					<form action="" method="post" enctype="multipart/form-data" role="form">
						...
						<div class="form-group">
							...
							<input type="number" name="br_item" class="form-control" placeholder=" Masukkan Jumlah item" />
						</div>
						<div class="form-group">
							<label> Harga Barang</label>
							<input type="number" name="br_hrg" class="form-control" placeholder=" Masukkan Harga Barang" />
						</div>
						<div class="form-group">
							<label> Stock Barang</label>
							<input type="number" name="br_stok" class="form-control" placeholder=" Masukkan Jumlah Stock" />
						</div>
						<div class="form-group">
					...
					?>
							...
							if ($pindah) {
								mysqli_query($koneksi, "insert into barang (br_nm,br_item,br_hrg,br_stok,br_satuan,ket,br_sts,br_gbr) values ('$br_nm','$br_item','$br_hrg','$br_stok','$br_satuan', '$ket','$br_sts' ,'$nama_gambar')");
							?>
