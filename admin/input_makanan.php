			...
			<div class="row">
				<div class="col-md-12">
					...
					?>
							...
							if ($pindah) {
								mysqli_query($koneksi, "insert into makanan (br_nm,br_item,br_hrg,br_stok,br_satuan,ket,br_sts,br_gbr) values ('$br_nm','$br_item','$br_hrg','$br_stok','$br_satuan', '$ket','$br_sts' ,'$nama_gambar')");
							?>
