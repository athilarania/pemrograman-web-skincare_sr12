  ...
  <form name="form1" method="post" action="">
    <div align="center">
      ...
      <table width="856" border="1" cellpadding="0" cellspacing="0">
        <tr bgcolor="#006600">
          <td width="41">
            <div align="center" class="style3">No.</div>
          </td>
          <td width="106">
            <div align="center" class="style3">Nama</div>
          </td>
          <td width="58">
            <div align="center" class="style3">No.Rekening</div>
          </td>
          <td width="183">
            <div align="center" class="style3">Nama Rekening</div>
          </td>
          <td width="183">
            <div align="center" class="style3">Nama Bank</div>
          </td>
          <td width="83">
            <div align="center" class="style3"> Email</div>
          </td>
          <td width="114">
            <div align="center" class="style3">Hp </div>
          </td>
          <td width="105">
            <div align="center" class="style3">Alamat </div>
          </td>
          <td width="114">
            <div align="center" class="style3">Kota</div>
          </td>
          <td width="183">
            <div align="center" class="style3">Kode Pos</div>
          </td>
        </tr>
