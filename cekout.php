							...
							<div class="table-responsive">
								...
								?>
									...
									<?php
										...
										$sql = mysqli_query($koneksi, "INSERT INTO transaksi (nama, username, password, email, alamat, pos, kota, hp, no_rek, nama_rek, bank) VALUES ('$nama','$username','$password','$email','$alamat','$pos','$kota','$hp','$no_rek','$nama_rek','$bank') ");
									?>
										<script type="text/javascript">
