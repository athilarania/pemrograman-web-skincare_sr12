	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="#"><span>TOKO ONLINE</span> Skincare SR 12</a></h1>
			</div>
	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li> SISTEM INFORMASI PENJUALAN BERBASIS WEB MINIMARKET AQILLA MART</li>
			</ul>
		</div>
	</div>
	<!-- //products-breadcrumb -->
	...
	<div class="banner">
			...
			<nav class="navbar nav_bottom">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li><a href="pakaian.php"> Skincare</a></li>
						<li><a href="makanan.php"> Kosmetik</a></li>
		...
		<div class="w3l_banner_nav_right">
			<section class="slider">
				...
				Kami adalah supermarket terlengkap, disini kamu dapat membeli apa saja yang kamu butuhkan dengan harga bersahabat, dekat dengan kampus !!<br>
				<b>Selamat berbelanja Customer ...</b>
										...
										<figure>
											<div class="snipcart-item block">
												<div class="snipcart-thumb">
													<img style="max-width: 210px;" src="admin/assets/images/<?php echo $data['br_gbr']; ?>" />
								...
								<div class="agile_top_brand_left_grid">
									...
									<div class="agile_top_brand_left_grid1">
										<figure>
											<div class="snipcart-item block">
												<div class="snipcart-thumb">
													<img style="max-width: 210px" src="admin/assets/images/makanan/<?php echo $data['br_gbr']; ?>" />
													<p><?php echo $data['br_nm']; ?></p>
													<h4>Rp.<?php echo number_format($data['br_hrg'], 2, ",", "."); ?> <span>$10.00</span></h4>
												</div>
												<div class="snipcart-details top_brand_home_details">
			...
			<div class="agile_footer_grids">
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						<h4>
							<p>© 2016 Aqilla Mart | Design by Yaminbae </p>
						</h4>
